...
// canvas2d_add_filter_* time, not per apply: the same list typically paints many
...
// radius, possibly 0, with dx/dy/color below).  canvas2d_filter_apply handles only
