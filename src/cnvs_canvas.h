...
// The canvas's private object model: struct canvas and struct canvas_state and
...
// (cnvs_encode.c, cnvs_imagedata.c) can read the surface and scratch buffers
...
#include "cnvs_gradient.h"  // struct cnvs_gradient
#include "cnvs_path.h"      // struct cnvs_path
#include "cnvs_stroke.h"    // enum cnvs_line_join, enum cnvs_line_cap
#include "cnvs_text.h"      // struct cnvs_font, struct cnvs_text_cache
