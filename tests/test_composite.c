...
static struct rgba blend(struct canvas2d_context *__single cv, int w, int h,
    ...
    canvas2d_set_fill_rgba(cv, CANVAS2D_CS_SRGB, br, bg, bb, 1.0f);
    canvas2d_fill_rect(cv, 0.0f, 0.0f, (float)w, (float)h);
    canvas2d_set_global_composite_operation(cv, op);
    canvas2d_set_fill_rgba(cv, CANVAS2D_CS_SRGB, sr, sg, sb, sa);
    canvas2d_fill_rect(cv, 0.0f, 0.0f, (float)w, (float)h);
