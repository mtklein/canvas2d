...
// trivially; the TEXT scenes additionally assert the cache saw real
...
// Every scene is a (program, image) pair of committed artifacts; `text`
// marks the text scenes whose cache traffic must be non-trivial.
