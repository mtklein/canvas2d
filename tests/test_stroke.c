...
int main(void) {
    ...
    canvas2d_move_to(cv, 8.0f, 32.0f);
    canvas2d_line_to(cv, 56.0f, 32.0f);
    canvas2d_stroke(cv);
    ...
    canvas2d_set_line_width(cv, 6.0f);
    canvas2d_begin_path(cv);
    canvas2d_move_to(cv, 0.0f, 32.0f);
    canvas2d_line_to(cv, 64.0f, 32.0f);
    canvas2d_stroke(cv);
    canvas2d_read_rgba(cv, CANVAS2D_CS_SRGB, px, len);
    ...
    canvas2d_set_line_dash(cv, dash, 0);  // back to solid
    ...
    canvas2d_begin_path(cv);
    canvas2d_move_to(cv, 20.0f, 32.0f);
    canvas2d_line_to(cv, 40.0f, 32.0f);
    canvas2d_stroke(cv);
    canvas2d_read_rgba(cv, CANVAS2D_CS_SRGB, px, len);
